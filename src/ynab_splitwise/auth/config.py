...
class Config(LoggerMixin):
    ...
    def __init__(self) -> None:
        ...
        self.splitwise_api_url = os.getenv("SPLITWISE_API_URL", "https://secure.splitwise.com/api/v3.0")
    ...
    def get_ynab_config(self) -> dict[str, str]:
        ...
        """
        return {
            "access_token": self.ynab_access_token,
            "host": self.ynab_api_url
        }